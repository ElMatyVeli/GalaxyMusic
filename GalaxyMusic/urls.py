...
urlpatterns = [
    ...
    path('carrito/aplicar_descuento/', views.aplicar_descuento, name='aplicar_descuento'),
    path('validacion_stock/', views.validacion_stock, name='validacion_stock'),
    ...
    path('registrar/', views.mostrar_registro, name='mostrar_registro'),  # Corregido a la función registrar_usuario
